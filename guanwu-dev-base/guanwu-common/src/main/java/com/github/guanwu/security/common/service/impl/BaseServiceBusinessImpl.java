package com.github.guanwu.security.common.service.impl;
 ...
 *
 * @author guanwu
 * @created on 2021-08-01 17:59:56
 **/
public class BaseServiceBusinessImpl <M extends Mapper<T>, T> implements BaseServiceBusiness<T> {
    @Autowired
    protected M mapper;
